...
import com.eatingdetection.gy.ihearfood.FoodLog.LogAdapter;
import com.eatingdetection.gy.ihearfood.FoodLog.LogData;

import com.eatingdetection.gy.ihearfood.FoodLog.Record;
import com.eatingdetection.gy.ihearfood.FoodLog.S2Tservice;
...
*/
    private BroadcastReceiver receiverAtMain = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.e("receiverAtMain", "Receive intent");

            data.add(new Record().getLastData());
            for(int i=0; i<data.size(); i++){
                Log.e("Chech data", data.get(i).getStartTime() + " ::: " + data.get(i).getEndTime() + " ::: " + data.get(i).getFoodInfo() + " ::: " + data.get(i).getIsConfirmed());
            }
...
*/
    ...
    protected void onDestroy() {
        super.onDestroy();
        unregisterReceiver(receiverAtMain);
    }
}
